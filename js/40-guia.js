...
const GUIA = [
  ...
  { grupo: 'Que la app trabaje sola', temas: [
    ...
    { id: 'atajos', icono: '📱', titulo: 'Botones en la pantalla de tu teléfono', pasos: ['Mantén presionado el ícono de <strong>Mi Pisto HN</strong>: salen <strong>Gasto, Ingreso, Dictar y Pago fijo</strong>.', 'En Android, <strong>arrastra</strong> el que más uses a la pantalla principal: queda como un botón propio, como un widget.', 'Un toque y se abre directo para anotar. Con PIN, el gasto, el ingreso y el dictado se anotan <strong>sin desbloquear</strong>: solo se puede agregar, nadie ve tus datos, y al entrar a la app pasa a tus movimientos.', 'En iPhone: app Atajos → <strong>+</strong> → Abrir URL con la dirección de la app seguida de <em>?action=new-expense</em>, y agrégalo a la pantalla de inicio.'], nota: '"Anotar sin desbloquear" se puede apagar en Configuración → Seguridad.' },
  ] },
