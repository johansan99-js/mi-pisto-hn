...
const SYNC_ARRAYS = ['transactions','goals','receivables','payables','prestamos','tarjetas','pagosRecurrentes','transferenciasProgramadas','grupos','presupuestos','misCuentas','categorias'];
...
function procesarAccionDeURL() {
  ...
  setTimeout(() => {
    ...
    else if (accion === 'new-income') abrirRegistro('ingreso');
    else if (accion === 'pago-fijo' && typeof abrirPagoFijo === 'function') abrirPagoFijo();
